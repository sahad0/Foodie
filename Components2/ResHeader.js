...
const ResHeader = ({ route }) => {
    const { name, img, city, rating, transaction, phone } = route.params
        ...
        <View>
            ...
            <View style={{ backgroundColor: "white", padding: "3%", paddingTop: "6%", position: "absolute", width: "100%", bottom: 0, height: "45%" }} >
                <View style={{ display: "flex", flexDirection: "row", justifyContent: "space-between" }}>
                    <Text style={{ fontFamily: "Cinzel", fontSize: 18, color: "black" }}>{name} </Text>
                ...
                <View style={{ display: "flex", flexDirection: "row", alignItems: "center", }}>
                    ...
                    <Text style={{ fontFamily: "Cinzel", fontSize: 12, color: "black" }}>{"(" + transaction + ")"}</Text>
                ...
                <View style={{ marginTop: "4%", display: "flex", flexDirection: "row", width: "100%" }}>
                    <TouchableOpacity style={{ display: "flex", flexDirection: "row", alignItems: "center", paddingTop: "2%" }}>
                        ...
                        <Text style={{ fontWeight: "100", fontFamily: "Cinzel", fontSize: 12, textDecorationLine: "underline", marginLeft: "1%", color: "black" }}>{phone}</Text>
                    </TouchableOpacity>
                    <View style={{ display: "flex", flexDirection: "row", width: "100%", paddingTop: "2%", paddingLeft: "5%", }}>
                        ...
                        <Text style={{ fontSize: 10, fontFamily: "Cinzel", color: "black" }}>{city}</Text>
                    </View>
                </View>
