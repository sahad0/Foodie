        ...
        <View>
            ...
            <View style={{ backgroundColor: "white", padding: "3%", paddingTop: "6%", position: "absolute", width: "100%", bottom: 0, height: "45%" }} >
                ...
                <View style={{ display: "flex", flexDirection: "row", alignItems: "center", }}>
                    ...
                    <Text style={{ fontFamily: "Cinzel", fontSize: 12, }}>{"(" + restaurantValue.transactions[0] + ","}</Text>
                    <Text style={{ fontFamily: "Cinzel", fontSize: 12, }}>{restaurantValue.transactions[1] + ")"}</Text>
                </View>
                ...
                <View style={{ marginTop: "4%", display: "flex", flexDirection: "row", width: "100%" }}>
                    <TouchableOpacity style={{ display: "flex", flexDirection: "row", alignItems: "center", paddingTop: "2%" }}>
                        <Ionicons name='call' />
                        <Text style={{ fontWeight: "100", fontFamily: "Cinzel", fontSize: 12, textDecorationLine: "underline", marginLeft: "1%", }}>{restaurantValue.phone}</Text>
                    </TouchableOpacity>
                    <View style={{ display: "flex", flexDirection: "row", width: "100%", paddingTop: "2%", paddingLeft: "5%" }}>
                        <Ionicons name='location-sharp' />
                        <Text style={{ fontSize: 10, fontFamily: "Cinzel", }}>{restaurantValue.location}</Text>
                    </View>
                </View>

            </View>
            <Divider style={{ width: "90%", display: "flex", alignSelf: "center", height: "0.4%" }} />
