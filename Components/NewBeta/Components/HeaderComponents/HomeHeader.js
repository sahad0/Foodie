  ...
  return (
    <>
      ...
      <View style={{flexDirection:"row",justifyContent:"flex-end"}}>
        {/* <TouchableOpacity style={{margin:height*0.03,marginRight:0,height:height*0.08,width:height*0.08,borderColor:"lightgray",borderWidth:0.5,borderRadius:height,justifyContent:"center",alignItems:"center"}}>
                <Ev name='gear' color={"black"} size={30} />
        </TouchableOpacity> */}
        <TouchableOpacity style={{margin:height*0.03,height:height*0.08,width:height*0.08,borderColor:"lightgray",borderWidth:0.5,borderRadius:height,justifyContent:"center",alignItems:"center"}}>
                <Icons name='heart' color={"#FF6EB4"} size={20} />
        </TouchableOpacity>
      </View>
