...
export default function BottomBar({ setModal }) {
    return (
        <View style={{ display: "flex", flexDirection: "row", alignSelf: "center", paddingBottom: "0%" }}>
            ...
            <View style={{ padding: "6%", paddingLeft: "8%", paddingRight: "4%" }}><TouchableOpacity onPress={() => { setModal(true) }}><Ionicons style={{ color: "black" }} name='basket-outline' size={24} /></TouchableOpacity></View>
